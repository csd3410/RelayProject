...
{
    /// <summary>
    /// The send mode of a <see cref="Message"/>.</summary>
    public enum MessageSendMode : byte
    {
        /// <summary>
        /// Unreliable send mode.</summary>
        unreliable = HeaderType.unreliable,

        /// <summary>
        /// Reliable send mode.</summary>
        reliable = HeaderType.reliable,
    }

    /// <summary>
    /// Provides functionality for converting data to bytes and vice versa.</summary>
    public class Message
    {
        /// <summary>
        /// The number of bytes required for a message's header.</summary>
        /// <remarks>
        ...
        /// <summary>
        /// The maximum number of bytes that a message can contain, including the <see cref="HeaderSize"/>.</summary>
        public static int MaxSize { get; private set; } = HeaderSize + 1225;
        
        /// <summary>
        /// The maximum number of bytes of payload data that a message can contain. 
        ///     This value represents how many bytes can be added to a message <i>on top of</i> the <see cref="HeaderSize"/>.</summary>
        ...
        /// <summary>
        /// How many messages to add to the pool for each <see cref="Server"/> or <see cref="Client"/> instance that is started.</summary>
        /// <remarks>Changes will not affect <see cref="Server"/> and <see cref="Client"/> instances 
        ///     which are already running until they are restarted.</remarks>
        public static byte InstancesPerSocket { get; set; } = 4;
        
        /// <summary>
        /// A pool of reusable message instances.</summary>
        private static readonly List<Message> pool = new List<Message>(InstancesPerSocket * 2);

        /// <summary>
        /// The message's send mode.</summary>
        public MessageSendMode SendMode { get; private set; }
        
        /// <summary>
        /// How often to try sending the message before giving up.</summary>
        /// <remarks>The default RUDP transport only uses this when sending messages 
        ///     with their <see cref="SendMode"/> set to <see cref="MessageSendMode.reliable"/>. 
        ///     Other transports may ignore this property entirely.</remarks>
        public int MaxSendAttempts { get; set; }
        
        /// <summary>
        /// The length in bytes of the unread data contained in the message.</summary>
        public int UnreadLength => writePos - readPos;
        
        /// <summary>
        /// The length in bytes of the data that has been written to the message.</summary>
        public int WrittenLength => writePos;
        
        /// <summary>
        /// How many more bytes can be written into the packet.</summary>
        internal int UnwrittenLength => Bytes.Length - writePos;
        
        /// <summary>
        /// The message's data.</summary>
        internal byte[] Bytes { get; private set; }

        /// <summary>
        /// The position in the byte array that the next bytes will be written to.</summary>
        private ushort writePos = 0;
        
        /// <summary>
        /// The position in the byte array that the next bytes will be read from.</summary>
        private ushort readPos = 0;

        /// <summary>
        /// Initializes a reusable <see cref="Message"/> instance.</summary>
        ...
        /// <summary>
        /// Trims the message pool to a more appropriate size for how many <see cref="Server"/> 
        /// and/or <see cref="Client"/> instances are currently running.</summary>
        ...
        /// <summary>
        /// Gets a usable message instance.</summary>
        ...
        /// <summary>
        /// Gets a message instance that can be used for sending.</summary>
        ...
        /// <param name="shouldAutoRelay">Whether or not <see cref="Server"/> instances should automatically 
        ///     relay this message to all other clients. 
        ///     This has no effect when <see cref="Server.AllowAutoMessageRelay"/> is set to <see langword="false"/> 
        ///     and does not affect how clients handle messages.</param>
        ...
        /// <remarks>As this message instance is returned straight from the pool, it will contain all previous data and settings.
        /// Using this instance without preparing it properly will likely result in unexpected behaviour.</remarks>
        ...
        /// <summary>
        /// The maximum number of elements an array can contain where the length still fits into a single byte.</summary>
        private const int OneByteLengthThreshold = 0b_0111_1111;
        
        /// <summary>
        /// The maximum number of elements an array can contain where the length still fits into two byte2.</summary>
        ...
        /// <summary>
        /// The name of a <see cref="byte"/> value.</summary>
        private const string ByteName        = "byte";
        
        /// <summary>
        /// The name of a <see cref="sbyte"/> value.</summary>
        private const string SByteName        = "sbyte";
        
        /// <summary>
        /// The name of a <see cref="bool"/> value.</summary>
        private const string BoolName        = "bool";
        
        /// <summary>
        /// The name of a <see cref="short"/> value.</summary>
        private const string ShortName       = "short";
        
        /// <summary>
        /// The name of a <see cref="ushort"/> value.</summary>
        private const string UShortName      = "ushort";
        
        /// <summary>
        /// The name of an <see cref="int"/> value.</summary>
        private const string IntName         = "int";
        
        /// <summary>
        /// The name of a <see cref="uint"/> value.</summary>
        private const string UIntName        = "uint";
        
        /// <summary>
        /// The name of a <see cref="long"/> value.</summary>
        private const string LongName        = "long";
        
        /// <summary>
        /// The name of a <see cref="ulong"/> value.</summary>
        private const string ULongName       = "ulong";
        
        /// <summary>
        /// The name of a <see cref="float"/> value.</summary>
        private const string FloatName       = "float";
        
        /// <summary>
        /// The name of a <see cref="double"/> value.</summary>
        private const string DoubleName      = "double";
        
        /// <summary>
        /// The name of a <see cref="string"/> value.</summary>
        private const string StringName      = "string";
        
        /// <summary>
        /// The name of an array length value.</summary>
