...
{
    /// <summary>
    /// Contains event data for when a client connects to the server.</summary>
    public class ServerClientConnectedEventArgs : EventArgs
    {
        /// <summary>
        /// The newly connected client.</summary>
        public IConnectionInfo Client { get; private set; }
        
        /// <summary>
        /// A message containing any custom data the client included when it connected.</summary>
        public Message ConnectMessage { get; private set; }

        /// <summary>
        /// Initializes event data.</summary>
    ...
    /// <summary>
    /// Contains event data for when the server receives a message from a client.</summary>
    public class ServerMessageReceivedEventArgs : EventArgs
    {
        /// <summary>
        /// The client that the message was received from.</summary>
        ...
        /// <summary>
        /// The message that was received.</summary>
    ...
    /// <summary>
    /// Contains event data for when a client disconnects from the server.</summary>
    public class ClientDisconnectedEventArgs : EventArgs
    {
        /// <summary>
        /// The numeric ID of the client that disconnected.</summary>
    ...
    /// <summary>
    /// Contains event data for when a new client connects.</summary>
    public class ClientConnectedEventArgs : EventArgs
    {
        /// <summary>
        /// The numeric ID of the newly connected client.</summary>
        public ushort Id { get; private set; }
    ...
    /// <summary>
    /// Contains event data for when the client receives a message from the server.</summary>
    ...
    /// <summary>
    /// Contains event data for when the client disconnects from a server.</summary>
    public class DisconnectedEventArgs : EventArgs
    {
        /// <summary>
        /// The reason for the disconnection.</summary>
        public DisconnectReason Reason { get; private set; }

        /// <summary>
        /// The custom reason included with the disconnection information (if any).</summary>
