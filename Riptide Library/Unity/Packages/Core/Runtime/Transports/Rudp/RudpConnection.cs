...
namespace Riptide.Transports.Rudp
{
    ...
    public class RudpConnection : IConnectionInfo
    {
        ...
        /// <summary>
        /// The connection's remote endpoint.</summary>
        public readonly IPEndPoint RemoteEndPoint;

        /// <summary>
        /// The client's <see cref="RudpPeer"/> instance.</summary>
        ...
        /// <summary>
        /// Whether or not the client has timed out.</summary>
        internal bool HasTimedOut => (DateTime.UtcNow - lastHeartbeat).TotalMilliseconds > server.ClientTimeoutTime;

        /// <summary>
        /// The time at which the last heartbeat was received from the client.</summary>
        private DateTime lastHeartbeat;

        /// <summary>
        /// The <see cref="RudpServer"/> that the client is associated with.</summary>
        private readonly RudpServer server;
        
        /// <summary>
        /// The client's current connection state.</summary>
        ...
        /// <summary>
        /// Sends a heartbeat message.</summary>
        ...
        /// <summary>
        /// Sends a welcome message.</summary>
