...
{
    /// <summary>
    /// Provides base sending &#38; receiving functionality for <see cref="RudpServer"/> and <see cref="RudpClient"/>.</summary>
    public abstract class RudpListener
    {
        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.timedOut"/>.</summary>
        protected const string ReasonTimedOut = "Timed out";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.kicked"/>.</summary>
        protected const string ReasonKicked = "Kicked";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.serverStopped"/>.</summary>
        protected const string ReasonServerStopped = "Server stopped";

        /// <summary>
        /// The text to log when disconnected due to <see cref="DisconnectReason.disconnected"/>.</summary>
        protected const string ReasonDisconnected = "Disconnected";

        /// <summary>
        /// The text to log when disconnected due to an unknown reason.</summary>
        protected const string ReasonUnknown = "Unknown reason";

        /// <summary>
        /// The name to use when logging messages via <see cref="RiptideLogger"/>.</summary>
        public readonly string LogName;

        /// <summary>
        /// The <see cref="ActionQueue"/> to use when invoking events.</summary>
        protected ActionQueue receiveActionQueue;

        /// <summary>
        /// How long to wait for a response, in microseconds.</summary>
        private const int ReceivePollingTime = 500000; // 0.5 seconds

        /// <summary>
        /// The socket to use for sending and receiving.</summary>
        private Socket socket;

        /// <summary>
        /// Whether or not the socket is ready to send and receive data.</summary>
        private bool isRunning = false;

        /// <summary>
        /// The buffer that incoming data is received into.</summary>
        private byte[] receiveBuffer;

        /// <summary>
        /// Handles initial setup.</summary>
        ...
        /// <summary>
        /// Stops listening for incoming packets.</summary>
        ...
        /// <summary>
        /// Listens for and receives incoming packets.</summary>
