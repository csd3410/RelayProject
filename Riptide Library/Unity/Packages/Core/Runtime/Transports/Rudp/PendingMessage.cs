...
{
    /// <summary>
    /// Represents a currently pending reliably sent message whose delivery has not been acknowledged yet.</summary>
    internal class PendingMessage
    {
        /// <summary>
        /// The multiplier used to determine how long to wait before resending a pending message.</summary>
        private const float RetryTimeMultiplier = 1.2f;

        /// <summary>
        /// A pool of reusable <see cref="PendingMessage"/> instances.</summary>
        private static readonly List<PendingMessage> pool = new List<PendingMessage>();

        /// <summary>
        /// The <see cref="RudpPeer"/> to use to send (and resend) the pending message.</summary>
        private RudpPeer peer;

        /// <summary>
        /// The intended destination endpoint of the message.</summary>
        private IPEndPoint remoteEndPoint;

        /// <summary>
        /// The sequence ID of the message.</summary>
        private ushort sequenceId;

        /// <summary>
        /// The contents of the message.</summary>
        ...
        /// <summary>
        /// How many send attempts have been made so far.</summary>
        private byte sendAttempts;

        /// <summary>
        /// The time of the latest send attempt.</summary>
        private DateTime lastSendTime;

        /// <summary>
        /// The timer responsible for triggering a resend, if all else fails 
        /// (like acks getting lost or redundant acks not being updated fast enough).</summary>
        ...
        #region Pooling
        /// <summary>
        /// Retrieves a <see cref="PendingMessage"/> instance, initializes it and then sends it.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a <see cref="PendingMessage"/> instance from the pool. 
        /// If none is available, a new instance is created.
        /// </summary>
        /// <returns>
        /// A <see cref="PendingMessage"/> instance.
        /// </returns>
        ...
        /// <summary>
        /// Returns the <see cref="PendingMessage"/> instance to the internal pool so it can be reused.
        /// </summary>
        ...
        /// <summary>
        /// Clears and removes the message from the dictionary of pending messages.</summary>
