...
namespace Riptide
{
    ...
    {
        /// <summary>For when a client's connection times out. 
        /// This also acts as the fallback reason—if a client disconnects and the message containing 
        /// the <i>real</i> reason is lost in transmission, it can't
        /// be resent as the connection will have already been closed. 
        /// As a result, the other end will time out the connection after a short period of time and this will be used 
        /// as the reason.</summary>
        timedOut,
    ...
    public abstract class Common
    {
        ...
        /// <summary>Increases <see cref="ActiveSocketCount"/>. 
        /// For use when a new <see cref="Server"/> or <see cref="Client"/> is started.</summary>
        protected static void IncreaseActiveSocketCount()
        {
            ActiveSocketCount++;
        }

        /// <summary>Decreases <see cref="ActiveSocketCount"/>. 
        /// For use when a <see cref="Server"/> or <see cref="Client"/> is stopped.</summary>
