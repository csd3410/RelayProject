...
{
    /// <summary>
    /// Contains values that are accessed by multiple threads and are used to inform the other end of which messages we've received.
    /// </summary>
    internal class SendLockables
    {
        ...
        /// <summary>
        /// Messages that we have received whose sequence IDs no longer fall into <see cref="AcksBitfield"/>'s range, 
        /// used to improve duplicate message filtering capabilities.
        /// </summary>
