...
{
    /// <summary>
    /// Provides functionality for sending and receiving messages reliably.</summary>
    internal class RudpPeer
    {
        /// <summary>
        /// The next sequence ID to use.</summary>
        internal ushort NextSequenceId => (ushort)Interlocked.Increment(ref lastSequenceId);
        
        /// <summary>
        /// The lockable values which are used to inform the other end of which messages we've received.</summary>
        internal SendLockables SendLockables { get; private set; }
        
        /// <summary>
        /// The lockable values which are used to determine which messages the other end has received.</summary>
        internal ReceiveLockables ReceiveLockables { get; private set; }
        
        /// <summary>
        /// The currently pending reliably sent messages whose delivery has not been acknowledged yet. Stored by sequence ID.</summary>
        ...
        /// <summary>
        /// The <see cref="RudpListener"/> whose socket to use when sending data.</summary>
        internal readonly RudpListener Listener;

        /// <summary>
        /// The last used sequence ID.</summary>
        private int lastSequenceId;
        
        /// <summary>
        /// A <see cref="ushort"/> with the left-most bit set to 1.</summary>
